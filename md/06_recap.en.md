...
4. <!-- .element: class="fragment highlight-green" --> if some producers threads started before some consumers, we could have a deadlock because of lost notifications
